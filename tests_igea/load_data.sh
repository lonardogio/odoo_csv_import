...
# python3 ../odoo_import_thread.py --file=tosend/5_sync_places.department.csv --model='sync_places.departmentr' --size=1 --worker=1 --conf=conf/connection_upload.conf --sep=";"
