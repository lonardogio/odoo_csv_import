...
if __name__ == '__main__':
    ...
    parser.add_argument('-c', '--config', dest='config', default="conf/connection_upload.conf", help='Configuration File that contains connection parameters', required = True)
